    ...
    <body style="background-image: url('../Images/Screen/img101.png')">
         <%!
            ...
            if(request.getParameter("bConfirm")!=null)
            {
                if(request.getParameter("tpass").equals(request.getParameter("cpass")))
                {
                   ...
                   ost =(OraclePreparedStatement) oconn.prepareStatement("update REGISTRATION set  PASSWORD=? where EMAIL=?");
                   ...
                   sess.invalidate();
                    ...
                    location.href="http://localhost:8080/Final_Project/FrontEnd/Login.html";
                </script>
                <%  
                }
                else
        ...
        <div>
            ...
            <table border="1" style="font-size: 100%; color:whitesmoke; background-color: black">
                ...
                <tfoot>
                    <th  colspan="2"> &copy; EDURA - The Best Learning &reg;</th>
                </tfoot>
            </table>
        </div>
            </form>
