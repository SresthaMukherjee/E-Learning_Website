...
<html>
    ...
    <body style="background-color: antiquewhite">
           ...
           ost =(OraclePreparedStatement) oconn.prepareStatement("SELECT * FROM REGISTRATION where EMAIL=?");
            ...
            if(request.getParameter("bVerify")!=null)
            {
                ...
                <script>
                    ...
                    location.href="http://localhost:8080/Final_Project/FrontEnd/NewPassword.jsp?pemail=<%=vemail%>";
                </script>
                <%
                }
                else
        ...
        <form name="frmSecurity" method="POST" action="http://localhost:8080/Final_Project/FrontEnd/VerifyQues.jsp?pemail=<%=vemail%>">
        <div>
            <table border="1">
                <thead>
                ...
                <tfoot>
                    <tr><th colspan="2">&copy; EDURA - The Best Learning &reg;</th></tr>
                </tfoot>
            </table>
        </div>
            </form>
